...
import { Briefcase, Building2, LayoutDashboard, ShieldAlert, ShieldCheck, Users, UserCog, FileStack, Sparkles, Bot } from "lucide-react";
...
const privilegedItems: Array<{ href: Route; label: string; icon: NavIcon }> = [
  ...
  { href: "/ai-playground" as Route, label: "AI Playground", icon: Bot }
];
